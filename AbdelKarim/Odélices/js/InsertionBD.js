...
//    $("#dateNaissance").datepicker();
    ...
    $("#btValider").on("click", function() {
        ...
        if (lbOK) {
            ...
            insererDansBD($("#pseudo").val(), $("#mdp").val());
        } else {
            // NADA
        }
    }
 ...
 * @returns {undefined}
 */
function insererDansBD(psTitre, psContenus, psIngrédients) {
    // Requete AJAX de type POST
    var jqXHR = $.post(
            "../Controls/Controls.php",
            {pseudo: psTitre, mdp: psContenus, email: psIngrédients}
 ...
 * MAIN
 */
$(document).ready(initInsertionBD);
